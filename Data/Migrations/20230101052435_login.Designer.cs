...
namespace AlbumProject.Data.Migrations
{
    ...
    [Migration("20230101052435_login")]
    partial class login
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlbumProject.Models.Album", b =>
                {
                    ...
                    b.Property<int>("AlbumScore")
                        .HasColumnType("int");

                    b.Property<int>("AlbumSongCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlbumProject.Models.Singer", b =>
                {
                    b.Property<int>("SingerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlbumProject.Models.UserDetails", b =>
                {
            ...
            modelBuilder.Entity("AlbumProject.Models.Album", b =>
                {
                    b.HasOne("AlbumProject.Models.Singer", "Sing")
                        .WithMany("Albums")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AlbumProject.Models.UserDetails", null)
                        .WithMany()
